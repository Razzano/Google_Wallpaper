...
(function() {
  ...
  const openInterval = 200,
        ...
        imgHeart = 'data:image/png;base64,',
        ...
        //settingPopup = $q('html[itemtype="http://schema.org/WebPage"] .UjBGL.pkWBse.iRQHZe');
  ...
  function searchLinksWhere() {
    ...
    for (let i = 0; i < links.length; i++) links[i].setAttribute('target', blank);
  }
  ...
  function wallpaper(e) {
    if (e === 0) {
      ...
      GM_addStyle(''+
        'body {'+
         '  background:  url(https://raw.githubusercontent.com/Razzano/MyWallpaper/master/image' + e + '.jpg) no-repeat center / cover !important;'+
        '}'+
      '');
  } }
