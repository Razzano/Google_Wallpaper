...
(function() {
  ...
  const openInterval = 200,
        ...
        inpThemer = $c('input', {id: 'inputThemer', type: 'number', min: 0, max: 35, value: GM_getValue('wallpaperImage'), title: inputTooltip}),
  ...
  function init() {
    ...
    try {
      ...
      //dateTimeContainer.appendChild(divThemer);
  ...
  function wallpaper(e) {
    if (e === 0) {
      ...
      GM_addStyle(''+
        ...
        '  background:  url('+ GM_getValue('imageSite') + e +'.jpg) no-repeat center / cover !important;'+
        '}'+
      '');
  } }
